...
<header>
    ...
    <input id="searchInput" type="search" name="query" placeholder="Поиск">
    <button id="searchId" type="submit">Найти</button>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="searchResult">
                            <?php require_once 'searchServer.php'; ?>
                        </div>
                    </div>
                </div>
            </div>
